-- Fix delete_user_admin function - remove references to non-existent sso_provider_id column
-- The auth.identities table doesn't have sso_provider_id, so we can't delete SSO providers by joining through it
...
BEGIN
  ...
  -- 6. Delete identities (this will cascade to related auth tables)
